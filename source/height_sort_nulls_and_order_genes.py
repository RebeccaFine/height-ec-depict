...
counter = 1
for null_file in glob.glob(null_files): #go through list of nulls in specified folder
    
    if counter in counters_to_keep:
        null_name = perm_name + '_perm_' + str(counter) # add name for null (e.g. pfizer_1)
